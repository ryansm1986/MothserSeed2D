...
If source poses overlap, effects bridge pose lanes, or frames are duplicated/near-duplicated/static, reject and regenerate the source. Do not try to salvage visibly contaminated or static sources by equal-slot slicing.
