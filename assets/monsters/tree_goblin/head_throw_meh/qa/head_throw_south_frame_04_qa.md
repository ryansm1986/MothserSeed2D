...
- Animation/direction/frame: `head_throw + south + frame 04 of 6`
- Planned frame beat: `No head in the picture; the head is offscreen after the throw, while the headless body follows through and begins preparing to receive it.`
...
- Primary source for this frame: `D:\projects\MotherSeed2D\assets\monsters\tree_goblin\head_throw\raw\head_throw_south_frame_03_raw.png`
- Previous approved frame: `D:\projects\MotherSeed2D\assets\monsters\tree_goblin\head_throw\raw\head_throw_south_frame_03_raw.png`
...
- Expected raw frame: `D:\projects\MotherSeed2D\assets\monsters\tree_goblin\head_throw\raw\head_throw_south_frame_04_raw.png`
- Expected normalized frame after direction normalization: `D:\projects\MotherSeed2D\assets\monsters\tree_goblin\head_throw\frames\head_throw_south_04.png`
...
- Fresh source confirmation: `Frame 04 was regenerated from approved frame 03 as the primary motion source and the original south base as identity/color/proportion/equipment reference.`
...
- Rejected frame attempts, if any: `old frame 04 superseded by user direction; no rejected attempt in this revised frame-04 pass`
...
- Frame 04 used the approved previous frame as primary source: `pass`
...
- Frame has no detached head, face, eyes, skull, or head-shaped object visible anywhere: `pass`
