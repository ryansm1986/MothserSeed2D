...
- Animation/direction/frame: `head_throw + south + frame 06 of 6`
- Planned frame beat: `Put head back on; the head is seated back on the body, hands press/release it into place, posture returns toward a readable south-facing stance with a small settling motion.`
...
- Primary source for this frame: `D:\projects\MotherSeed2D\assets\monsters\tree_goblin\head_throw\raw\head_throw_south_frame_05_raw.png`
- Previous approved frame: `D:\projects\MotherSeed2D\assets\monsters\tree_goblin\head_throw\raw\head_throw_south_frame_05_raw.png`
...
- Expected raw frame: `D:\projects\MotherSeed2D\assets\monsters\tree_goblin\head_throw\raw\head_throw_south_frame_06_raw.png`
- Expected normalized frame after direction normalization: `D:\projects\MotherSeed2D\assets\monsters\tree_goblin\head_throw\frames\head_throw_south_06.png`
...
- Fresh source confirmation: `Frame 06 used approved frame 05 as primary motion source and the original south base as identity/color/proportion/equipment reference.`
...
- Frame 06 used the approved previous frame as primary source: `pass`
...
- Exactly one head is visible and attached back on the body: `pass`
