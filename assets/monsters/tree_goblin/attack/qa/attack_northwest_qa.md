...
- Animation/direction: `attack + northwest`
...
- Frame count: `8`
- Frame-by-frame pose plan: `D:\projects\MotherSeed2D\assets\monsters\tree_goblin\attack\qa\attack_northwest_plan.json`
...
- Generated one-by-one source attempt: `D:\projects\MotherSeed2D\assets\monsters\tree_goblin\attack\raw\attack_northwest_generated_attempt_01_base_style.png`
- Generated attempt source spacing measurement: `[86, 38, 57, 25, 0, 0, 58]`
- Repacked raw source-strip spacing measurement: `[384, 384, 384, 384, 384, 384, 384]`
- Expected raw strip: `D:\projects\MotherSeed2D\assets\monsters\tree_goblin\attack\raw\attack_northwest_raw.png`
- Expected normalized frames: `D:\projects\MotherSeed2D\assets\monsters\tree_goblin\attack\frames\attack_northwest_01.png` through `attack_northwest_08.png`
- Expected preview: `D:\projects\MotherSeed2D\assets\monsters\tree_goblin\attack\preview\attack_northwest_preview.png`
- Expected review GIF: `D:\projects\MotherSeed2D\assets\monsters\tree_goblin\attack\gif\attack_northwest.gif`

## Frame-by-frame pose plan

1. Wind-up: northwest-facing hunch toward the left shoulder, left arm still attached.
2. Grip/tear: claw digs into the shoulder joint, torso twists up-left, sap starts.
3. Rip free: left arm tears loose as a limb-club, shoulder stump visible.
4. Draw back: severed arm-club pulls back while the northwest facing is preserved.
5. Strike/contact: club sweeps through the northwest attack lane.
6. Follow-through: body rotates through the up-left swing, moss and chips trailing.
7. Recovery: club lowers, missing shoulder remains visible.
8. Loop-ready reset: crouched northwest-facing ready pose with the arm-club close.
