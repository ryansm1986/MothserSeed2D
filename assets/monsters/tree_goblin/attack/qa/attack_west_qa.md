...
- Animation/direction: `attack + west`
...
- Frame count: `8`
- Frame-by-frame pose plan: `D:\projects\MotherSeed2D\assets\monsters\tree_goblin\attack\qa\attack_west_plan.json`
...
- Generated one-by-one source attempt: `D:\projects\MotherSeed2D\assets\monsters\tree_goblin\attack\raw\attack_west_generated_attempt_02_base_style.png`
- Generated attempt source spacing measurement: `[59, 33, 0, 0, 0, 0, 54]`
- Repacked raw source-strip spacing measurement: `[384, 384, 384, 384, 384, 384, 384]`
- Expected raw strip: `D:\projects\MotherSeed2D\assets\monsters\tree_goblin\attack\raw\attack_west_raw.png`
- Expected normalized frames: `D:\projects\MotherSeed2D\assets\monsters\tree_goblin\attack\frames\attack_west_01.png` through `attack_west_08.png`
- Expected preview: `D:\projects\MotherSeed2D\assets\monsters\tree_goblin\attack\preview\attack_west_preview.png`
- Expected review GIF: `D:\projects\MotherSeed2D\assets\monsters\tree_goblin\attack\gif\attack_west.gif`

## Frame-by-frame pose plan

1. Wind-up: west-facing side hunch toward the left shoulder, left arm still attached.
...
5. Strike/contact: heavy club swing forward to the west.
6. Follow-through: club carries through the westward arc, body leaning into the swing.
7. Recovery: club lowers, missing shoulder visible from the side.
8. Loop-ready reset: crouched west-facing ready pose with the arm-club close.
