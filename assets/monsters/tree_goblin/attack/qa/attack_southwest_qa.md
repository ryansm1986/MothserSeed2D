...
- Animation/direction: `attack + southwest`
...
- Frame count: `8`
- Frame-by-frame pose plan: `D:\projects\MotherSeed2D\assets\monsters\tree_goblin\attack\qa\attack_southwest_plan.json`
...
- Generated one-by-one source attempt: `D:\projects\MotherSeed2D\assets\monsters\tree_goblin\attack\raw\attack_southwest_generated_attempt_01_base_style.png`
- Generated attempt source spacing measurement: `[79, 44, 25, 0, 0, 0, 46]`
- Repacked raw source-strip spacing measurement: `[384, 384, 384, 384, 384, 384, 384]`
- Expected raw strip: `D:\projects\MotherSeed2D\assets\monsters\tree_goblin\attack\raw\attack_southwest_raw.png`
- Expected normalized frames: `D:\projects\MotherSeed2D\assets\monsters\tree_goblin\attack\frames\attack_southwest_01.png` through `attack_southwest_08.png`
- Expected preview: `D:\projects\MotherSeed2D\assets\monsters\tree_goblin\attack\preview\attack_southwest_preview.png`
- Expected review GIF: `D:\projects\MotherSeed2D\assets\monsters\tree_goblin\attack\gif\attack_southwest.gif`

## Frame-by-frame pose plan

1. Wind-up: southwest-facing hunch toward the left shoulder, left arm still attached.
2. Grip/tear: claw digs into the shoulder joint in diagonal perspective, bark cracks, sap starts.
3. Rip free: left arm tears loose as a limb-club, body recoils while staying southwest-facing.
4. Draw back: severed arm-club pulls back through the southwest silhouette.
5. Strike/contact: club sweeps through the southwest attack lane, root feet braced.
...
8. Loop-ready reset: crouched southwest-facing ready pose holding the arm-club close.
