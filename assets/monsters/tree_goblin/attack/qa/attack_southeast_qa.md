...
- Animation/direction: `attack + southeast`
...
- Frame count: `8`
- Frame-by-frame pose plan: `D:\projects\MotherSeed2D\assets\monsters\tree_goblin\attack\qa\attack_southeast_plan.json`
...
- Generated one-by-one source attempt: `D:\projects\MotherSeed2D\assets\monsters\tree_goblin\attack\raw\attack_southeast_generated_attempt_01_base_style.png`
- Generated attempt source spacing measurement: `[58, 62, 35, 46, 0, 0, 79]`
- Repacked raw source-strip spacing measurement: `[384, 384, 384, 384, 384, 384, 384]`
- Expected raw strip: `D:\projects\MotherSeed2D\assets\monsters\tree_goblin\attack\raw\attack_southeast_raw.png`
- Expected normalized frames: `D:\projects\MotherSeed2D\assets\monsters\tree_goblin\attack\frames\attack_southeast_01.png` through `attack_southeast_08.png`
- Expected preview: `D:\projects\MotherSeed2D\assets\monsters\tree_goblin\attack\preview\attack_southeast_preview.png`
- Expected review GIF: `D:\projects\MotherSeed2D\assets\monsters\tree_goblin\attack\gif\attack_southeast.gif`

## Frame-by-frame pose plan

1. Wind-up: southeast-facing hunch toward the left shoulder, left arm still attached.
2. Grip/tear: claw digs into the shoulder joint in diagonal perspective, bark cracks, sap starts.
3. Rip free: left arm tears loose as a limb-club, body recoils while staying southeast-facing.
4. Draw back: severed arm-club pulls back through the southeast silhouette.
5. Strike/contact: club sweeps through the southeast attack lane, root feet braced.
6. Follow-through: body rotates with the swing, moss and bark chips trailing.
7. Recovery: club lowers, missing shoulder remains visible.
8. Loop-ready reset: crouched southeast-facing ready pose holding the arm-club close.
