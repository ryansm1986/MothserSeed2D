# Agent Job Prompt: idle_southwest
...
Task: Work only on `idle_southwest`, which is `idle/southwest` with `5` frames.

Use these exact base picture reference(s): D:\projects\MotherSeed2D\assets\monsters\shroom_boy\base\south.png;D:\projects\MotherSeed2D\assets\monsters\shroom_boy\base\west.png

Frame-by-frame pose plan:
1. Neutral `southwest` idle stance: feet/body planted, cap/head settled, face oriented correctly, hands relaxed near the body.
