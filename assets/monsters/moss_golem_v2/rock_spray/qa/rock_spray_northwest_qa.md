# rock_spray_northwest QA

Status: `needs_revision`

## Inputs

- Queue row: `rock_spray_northwest`
...
- Animation/direction: `rock_spray + northwest`
- One-direction-only source: `confirmed northwest-only source strip`
...
- Mapped base source(s): `D:\projects\MotherSeed2D\assets\monsters\moss_golem_v2\base\north.png;D:\projects\MotherSeed2D\assets\monsters\moss_golem_v2\base\west.png`
...
- Frame count: `8`
- Frame-by-frame pose plan: `D:\projects\MotherSeed2D\assets\monsters\moss_golem_v2\rock_spray\raw\rock_spray_northwest_pose_plan.md`
- Subject size: `large`
...
- Expected raw strip: `D:\projects\MotherSeed2D\assets\monsters\moss_golem_v2\rock_spray\raw\rock_spray_northwest_raw.png`
- Expected normalized frames: `D:\projects\MotherSeed2D\assets\monsters\moss_golem_v2\rock_spray\frames\rock_spray_northwest_01.png` through `rock_spray_northwest_08.png`
- Expected preview: `D:\projects\MotherSeed2D\assets\monsters\moss_golem_v2\rock_spray\preview\rock_spray_northwest_preview.png`
- Expected review GIF: `D:\projects\MotherSeed2D\assets\monsters\moss_golem_v2\rock_spray\gif\rock_spray_northwest.gif`
- Local tools: `assets/monsters/moss_golem_v2/rock_spray/tools/rock_spray_northwest_process.py;assets/monsters/moss_golem_v2/rock_spray/tools/rock_spray_queue_finalize_tool.py`
...
- Fresh helper tools created under `<animation>/tools/`: `assets/monsters/moss_golem_v2/rock_spray/tools/rock_spray_northwest_process.py;assets/monsters/moss_golem_v2/rock_spray/tools/rock_spray_queue_finalize_tool.py`
...
- Source image contains one horizontal strip for `northwest` only.
...
- Generated one fresh 8-frame `rock_spray_northwest` strip.
...
Generated and normalized successfully as a one-direction strip. This source has improved spacing versus the south/down attempt, but the initial source strip still does not provide the strict 1152px full-frame empty spacing required by PIPELINE_TEMPLATE.md.
