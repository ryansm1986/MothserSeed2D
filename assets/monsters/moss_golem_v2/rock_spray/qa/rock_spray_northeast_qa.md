# rock_spray_northeast QA

Status: `needs_revision`

## Inputs

- Queue row: `rock_spray_northeast`
...
- Animation/direction: `rock_spray + northeast`
- One-direction-only source: `confirmed northeast-only source strip`
...
- Frame count: `8`
- Frame-by-frame pose plan: `D:\projects\MotherSeed2D\assets\monsters\moss_golem_v2\rock_spray\raw\rock_spray_northeast_pose_plan.md`
- Subject size: `large`
...
- Expected raw strip: `D:\projects\MotherSeed2D\assets\monsters\moss_golem_v2\rock_spray\raw\rock_spray_northeast_raw.png`
- Expected normalized frames: `D:\projects\MotherSeed2D\assets\monsters\moss_golem_v2\rock_spray\frames\rock_spray_northeast_01.png` through `rock_spray_northeast_08.png`
- Expected preview: `D:\projects\MotherSeed2D\assets\monsters\moss_golem_v2\rock_spray\preview\rock_spray_northeast_preview.png`
- Expected review GIF: `D:\projects\MotherSeed2D\assets\monsters\moss_golem_v2\rock_spray\gif\rock_spray_northeast.gif`
- Local tools: `assets/monsters/moss_golem_v2/rock_spray/tools/rock_spray_northeast_process.py;assets/monsters/moss_golem_v2/rock_spray/tools/rock_spray_queue_finalize_tool.py`
...
- Fresh helper tools created under `<animation>/tools/`: `assets/monsters/moss_golem_v2/rock_spray/tools/rock_spray_northeast_process.py;assets/monsters/moss_golem_v2/rock_spray/tools/rock_spray_queue_finalize_tool.py`
...
- Source image contains one horizontal strip for `northeast` only.
...
- Generated one fresh 8-frame `rock_spray_northeast` strip.
...
Generated and normalized successfully as a one-direction strip with compact spray and reduced visible lane bleed, but the initial source strip still does not provide the strict 1152px full-frame empty spacing required by PIPELINE_TEMPLATE.md.
