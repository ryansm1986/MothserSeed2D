...
- Animation/direction: `rock_spray + east`
- One-direction-only source: `confirmed east-only source strip`
...
- Mapped base source(s): `D:\projects\MotherSeed2D\assets\monsters\moss_golem_v2\base\east.png`
...
- Frame count: `8`
- Frame-by-frame pose plan: `D:\projects\MotherSeed2D\assets\monsters\moss_golem_v2\rock_spray\raw\rock_spray_east_pose_plan.md`
- Subject size: `large`
...
- Expected raw strip: `D:\projects\MotherSeed2D\assets\monsters\moss_golem_v2\rock_spray\raw\rock_spray_east_raw.png`
- Expected normalized frames: `D:\projects\MotherSeed2D\assets\monsters\moss_golem_v2\rock_spray\frames\rock_spray_east_01.png` through `rock_spray_east_08.png`
- Expected preview: `D:\projects\MotherSeed2D\assets\monsters\moss_golem_v2\rock_spray\preview\rock_spray_east_preview.png`
- Expected review GIF: `D:\projects\MotherSeed2D\assets\monsters\moss_golem_v2\rock_spray\gif\rock_spray_east.gif`
- Local tools: `assets/monsters/moss_golem_v2/rock_spray/tools/rock_spray_east_process.py;assets/monsters/moss_golem_v2/rock_spray/tools/rock_spray_queue_finalize_tool.py`
...
- Fresh helper tools created under `<animation>/tools/`: `assets/monsters/moss_golem_v2/rock_spray/tools/rock_spray_east_process.py;assets/monsters/moss_golem_v2/rock_spray/tools/rock_spray_queue_finalize_tool.py`
...
- Source image contains one horizontal strip for `east` only.
...
- Generated one fresh 8-frame `rock_spray_east` strip.
...
Generated and normalized successfully with visibly reduced rock bleed compared with south/down, but the initial source strip still does not provide the strict 1152px full-frame empty spacing required by PIPELINE_TEMPLATE.md.
