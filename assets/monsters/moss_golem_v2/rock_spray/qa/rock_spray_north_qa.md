...
- Animation/direction: `rock_spray + north`
- One-direction-only source: `confirmed north-only source strip`
...
- Frame count: `8`
- Frame-by-frame pose plan: `D:\projects\MotherSeed2D\assets\monsters\moss_golem_v2\rock_spray\raw\rock_spray_north_pose_plan.md`
- Subject size: `large`
...
- Expected raw strip: `D:\projects\MotherSeed2D\assets\monsters\moss_golem_v2\rock_spray\raw\rock_spray_north_raw.png`
- Expected normalized frames: `D:\projects\MotherSeed2D\assets\monsters\moss_golem_v2\rock_spray\frames\rock_spray_north_01.png` through `rock_spray_north_08.png`
- Expected preview: `D:\projects\MotherSeed2D\assets\monsters\moss_golem_v2\rock_spray\preview\rock_spray_north_preview.png`
- Expected review GIF: `D:\projects\MotherSeed2D\assets\monsters\moss_golem_v2\rock_spray\gif\rock_spray_north.gif`
- Local tools: `assets/monsters/moss_golem_v2/rock_spray/tools/rock_spray_north_process.py;assets/monsters/moss_golem_v2/rock_spray/tools/rock_spray_queue_finalize_tool.py`
...
- Fresh helper tools created under `<animation>/tools/`: `assets/monsters/moss_golem_v2/rock_spray/tools/rock_spray_north_process.py;assets/monsters/moss_golem_v2/rock_spray/tools/rock_spray_queue_finalize_tool.py`
...
- Source image contains one horizontal strip for `north` only.
...
- Generated one fresh 8-frame `rock_spray_north` strip.
...
Generated and normalized successfully as a one-direction strip. QA caveats: the rear-facing row uses an invented visible green back aperture to express the requested core-opening action, and the initial source strip still does not provide the strict 1152px full-frame empty spacing required by PIPELINE_TEMPLATE.md.
