...
- Face consistency pass: source `southeast.png` head/mask details were overlaid on all 5 normalized frames so the face reads as glowing eyes only, with no generated mouth, nose, snout, lips, or teeth.
