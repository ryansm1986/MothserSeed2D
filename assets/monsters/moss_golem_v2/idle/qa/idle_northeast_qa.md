...
- Face consistency pass: source `northeast.png` head/mask details were overlaid on all 5 normalized frames so the face reads as glowing eye only, with no generated mouth, nose, snout, lips, or teeth.
