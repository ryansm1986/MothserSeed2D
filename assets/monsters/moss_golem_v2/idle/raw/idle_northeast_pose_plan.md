...
Mapped base sources: `assets/monsters/moss_golem_v2/base/north.png`, `assets/monsters/moss_golem_v2/base/east.png`

1. Grounded northeast-facing neutral stance showing the back/side mass, heavy arms low, head turned northeast, moss blanket steady.
...
Source strip requirement: one horizontal `idle_northeast` strip only, exactly 5 distinct newly drawn northeast-facing poses, flat `#ff00ff` background, at least 384 px empty `#ff00ff` gutter between neighboring visible pose bounds before normalization.
