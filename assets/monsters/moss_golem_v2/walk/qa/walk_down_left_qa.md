...
- Expected raw strip: `assets/monsters/moss_golem_v2/walk/raw/walk_down_left_raw.png`
- Expected normalized frames: `assets/monsters/moss_golem_v2/walk/frames/walk_down_left_01.png` through `walk_down_left_08.png`
- Expected preview: `assets/monsters/moss_golem_v2/walk/preview/walk_down_left_preview.png`
- Expected 4x preview: `assets/monsters/moss_golem_v2/walk/preview/walk_down_left_preview_4x.png`
- Expected focused QA preview: `assets/monsters/moss_golem_v2/walk/preview/walk_down_left_focused_qa.png`
- Expected review GIF: `assets/monsters/moss_golem_v2/walk/gif/walk_down_left.gif`
...
- Generated source candidate: `assets/monsters/moss_golem_v2/walk/raw/walk_down_left_imagegen_source_chromakey.png`
- Rejected source attempts, if any: `The accepted candidate still fails the strict initial source spacing gate: measured minimum generated gutter 71px, required 384px. A grouped/repacked raw strip with 384px gutters was created for review, but the queue row is not approved.`
- Other references explicitly approved by user, if any: `None`

## Automated QA

- Source pose groups detected: `8` / `8`
- Generated source minimum visible-pose gutter: `71px`
- Initial source spacing gate: `FAIL`
- Normalized frame size: `384x384`
- Shared normalization scale: `1.204`
- Frame-edge contact: `PASS`
- Frame 01: edge padding left/top/right/bottom = (80, 36, 79, 24)
- Frame 02: edge padding left/top/right/bottom = (68, 42, 68, 24)
- Frame 03: edge padding left/top/right/bottom = (74, 37, 73, 24)
- Frame 04: edge padding left/top/right/bottom = (90, 50, 89, 24)
- Frame 05: edge padding left/top/right/bottom = (72, 43, 71, 24)
- Frame 06: edge padding left/top/right/bottom = (74, 40, 73, 24)
- Frame 07: edge padding left/top/right/bottom = (82, 40, 82, 24)
- Frame 08: edge padding left/top/right/bottom = (70, 43, 69, 24)
...
- Generated one fresh 8-frame `walk_down_left` strip for `walk + down_left`.
