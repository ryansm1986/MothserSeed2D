...
- Expected raw strip: `assets/monsters/moss_golem_v2/walk/raw/walk_down_raw.png`
- Expected normalized frames: `assets/monsters/moss_golem_v2/walk/frames/walk_down_01.png` through `walk_down_08.png`
- Expected preview: `assets/monsters/moss_golem_v2/walk/preview/walk_down_preview.png`
- Expected 4x preview: `assets/monsters/moss_golem_v2/walk/preview/walk_down_preview_4x.png`
- Expected focused QA preview: `assets/monsters/moss_golem_v2/walk/preview/walk_down_focused_qa.png`
- Expected review GIF: `assets/monsters/moss_golem_v2/walk/gif/walk_down.gif`
...
- Generated source candidate: `assets/monsters/moss_golem_v2/walk/raw/walk_down_imagegen_source_chromakey.png`
- Rejected source attempts, if any: `The accepted candidate still fails the strict initial source spacing gate: measured minimum generated gutter 73px, required 384px. A grouped/repacked raw strip with 384px gutters was created for review, but the queue row is not approved.`
- Other references explicitly approved by user, if any: `None`

## Automated QA

- Source pose groups detected: `8` / `8`
- Generated source minimum visible-pose gutter: `73px`
- Initial source spacing gate: `FAIL`
- Normalized frame size: `384x384`
- Shared normalization scale: `1.453`
- Frame-edge contact: `PASS`
- Frame 01: edge padding left/top/right/bottom = (44, 36, 44, 24)
- Frame 02: edge padding left/top/right/bottom = (46, 37, 46, 24)
- Frame 03: edge padding left/top/right/bottom = (50, 48, 49, 24)
- Frame 04: edge padding left/top/right/bottom = (50, 64, 51, 24)
- Frame 05: edge padding left/top/right/bottom = (52, 48, 53, 24)
- Frame 06: edge padding left/top/right/bottom = (50, 53, 51, 24)
- Frame 07: edge padding left/top/right/bottom = (46, 64, 45, 24)
- Frame 08: edge padding left/top/right/bottom = (50, 48, 49, 24)
...
- Generated one fresh 8-frame `walk_down` strip for `walk + down`.
