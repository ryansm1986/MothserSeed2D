...
- Animation/direction: `rock_slam + right`
...
- Expected raw strip: `assets/monsters/moss_golem_v2/rock_slam/raw/rock_slam_right_raw.png`
- Expected normalized frames: `assets/monsters/moss_golem_v2/rock_slam/frames/rock_slam_right_01.png` through `rock_slam_right_08.png`
- Expected preview: `assets/monsters/moss_golem_v2/rock_slam/preview/rock_slam_right_preview.png`
- Expected review GIF: `assets/monsters/moss_golem_v2/rock_slam/gif/rock_slam_right.gif`
...
- Generated source path: `assets/monsters/moss_golem_v2/rock_slam/raw/rock_slam_right_imagegen_source_chromakey.png`
- Repacked raw path: `assets/monsters/moss_golem_v2/rock_slam/raw/rock_slam_right_raw.png`
...
- Shared normalization scale for this row: `1.907`
- Anchor: `{ x: 576, y: 1128 }`
...
- [x] Generated one fresh `8`-frame `rock_slam_right` strip for `rock_slam + right`.
