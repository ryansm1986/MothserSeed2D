...
- Height guard: per-frame visible heights [98, 98, 98, 98, 95, 96, 96, 98]; drift 3 px.
- Padding/no-crop: worst normalized padding L/T/R/B = [33, 14, 32, 16]; no alpha touches frame edge.
- Raw gutters: 640px slots, estimated minimum transparent gutter 430 px; chroma source cleanup removed gradient magenta background and no inter-pose alpha bleed remains after repack.
