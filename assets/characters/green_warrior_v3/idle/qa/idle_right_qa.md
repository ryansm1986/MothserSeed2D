...
Animation/direction: `idle` + `right`.
...
- Direction: intended `right` for all five frames.
...
- Padding/no-crop: worst normalized padding L/T/R/B = [39, 14, 38, 16]; no alpha touches frame edge.
- Raw gutters: 640px slots, estimated minimum transparent gutter 394 px; no inter-pose alpha bleed remains after repack.

Outputs:

- Source chromakey: `assets\characters\green_warrior_v3\idle\raw\idle_right_imagegen_base_only_natural_stance_chromakey.png`
- Alpha cleanup: `assets\characters\green_warrior_v3\idle\raw\idle_right_imagegen_base_only_natural_stance_alpha.png`
- Raw: `assets\characters\green_warrior_v3\idle\raw\idle_right_raw.png`
- Chroma raw: `assets\characters\green_warrior_v3\idle\raw\idle_right_raw_chromakey.png`
- Frames: `assets\characters\green_warrior_v3\idle\frames\idle_right_01.png` through `assets\characters\green_warrior_v3\idle\frames\idle_right_05.png`
- Preview: `assets\characters\green_warrior_v3\idle\preview\idle_right_preview.png`
- 4x preview: `assets\characters\green_warrior_v3\idle\preview\idle_right_preview_4x.png`
- Weapon/no-shield focus: `assets\characters\green_warrior_v3\idle\preview\idle_right_weapon_no_shield_focus.png`
- Side-padding/no-crop check: `assets\characters\green_warrior_v3\idle\preview\idle_right_side_padding_no_crop_check.png`
- GIF: `assets\characters\green_warrior_v3\idle\gif\idle_right.gif`
